...
* kod źródłowy biblioteki do składania i weryfikacji podpisu elektronicznego plików XML [ABCPRO.NES.XAdES](https://github.com/abcpro-pl/elektronizacja-prawa/tree/master/nes/v2.0/Abc.Nes.Xades)
