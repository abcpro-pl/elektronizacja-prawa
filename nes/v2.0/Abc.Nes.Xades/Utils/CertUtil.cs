    ...
    public static class CertUtil {
        ...
        public static X509Certificate2 SelectCertificate(string message = null, string title = null) {
            ...
            try {
                ...
                X509Certificate2Collection scollection = X509Certificate2UI.SelectFromCollection(fcollection, title, message, 
                ...
                // Thx @rasputino
                throw new Exception("Could not get private key.", ex);
            }
