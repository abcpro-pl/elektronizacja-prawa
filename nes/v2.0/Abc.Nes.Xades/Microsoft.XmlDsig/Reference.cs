                ...
                switch (_refTargetType) {
                    ...
                    case ReferenceTargetType.UriReference:
                        ...
                        if (_uri == null) {
                            ...
                            if (document == null)
                                throw new CryptographicException(String.Format(SR.Cryptography_Xml_SelfReferenceRequiresContext, _uri));
                        ...
                        else if (_uri != null && _uri.StartsWith("http")) {
                            // WebRequest always expects an Absolute Uri, so try to resolve if we were passed a relative Uri.
                            var uri = new System.Uri(_uri, UriKind.RelativeOrAbsolute);
