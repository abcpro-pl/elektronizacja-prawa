...
namespace Microsoft.XmlDsig {
    internal class SignedXml {
        ...
        protected bool[] _refProcessed;
        protected int[] _refLevelCache;
        ...
        public void ComputeSignature(KeyedHashAlgorithm macAlg) {
            ...
            BuildDigestedReferences();
            SignedInfo.SignatureMethod = GetSignatureMethod(hash.HashName);
        ...
        private string GetSignatureMethod(string hashName) {
            switch (hashName) {
                case "SHA1": return SignedXml.XmlDsigHMACSHA1Url;
                case "SHA256": return SignedXml.XmlDsigMoreHMACSHA256Url;
                case "SHA384": return SignedXml.XmlDsigMoreHMACSHA384Url;
                case "SHA512": return SignedXml.XmlDsigMoreHMACSHA512Url;
                case "MD5": return SignedXml.XmlDsigMoreHMACMD5Url;
                case "RIPEMD160": return SignedXml.XmlDsigMoreHMACRIPEMD160Url;
                default: throw new CryptographicException(SR.Cryptography_Xml_SignatureMethodKeyMismatch);
            };
        }
        ...
        protected virtual void BuildDigestedReferences() {
        ...
        protected virtual bool CheckDigestedReferences() {
